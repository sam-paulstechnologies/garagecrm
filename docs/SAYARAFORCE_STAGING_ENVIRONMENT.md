...
The pending migrations run in reviewed order after the baseline: `2026_08_05_000001_create_messaging_core_tables` creates seven messaging tables, `2026_08_10_000001_create_commercial_foundation` adds eight commercial-foundation tables, `2026_08_10_000002_create_ai_monitoring_metering` adds two tenant-scoped metering/telemetry tables, `2026_08_10_000003_create_billing_engine` adds three provider-neutral billing tables plus verified-event lifecycle fields, `2026_08_10_000004_create_mobile_notification_foundation` adds two tenant-scoped notification tables, `2026_08_10_000005_create_product_events` adds one privacy-minimized product-event table, `2026_08_10_000006_create_messaging_number_claims` adds the tenant-scoped pre-Meta E.164 claim/linkage structure, `2026_08_11_000001_harden_billing_payment_lifecycle` separates checkout confirmation from verified payment activation while attributing invoice history to its immutable price and test mode, and `2026_08_12_000001_add_launch_offer_commercial_policy` adds the audited global offer switch and durable checkout/subscription promotional history. Two independent fresh cycles produced 128 base tables, two valid views, 49 migration records, two explicitly subscribed synthetic tenants, zero foreign-key violations across 166 constraints, 464 routes, and identical fingerprint `30898ba38ad4b1d9031e8cdd26d99eb0d09f99695ffeccb7fa2a9c0fe6d91ce8`.
