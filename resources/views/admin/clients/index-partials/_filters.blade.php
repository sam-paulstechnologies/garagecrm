...
>
    <form method="GET" action="{{ route('admin.clients.index') }}">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <div class="flex min-w-0 flex-wrap items-center gap-1.5">
                        @foreach($activeSummary as $summaryItem)
                            <span class="sf-client-filter-pill inline-flex rounded-full border px-2 py-0.5 text-[11px] font-bold">
                                {{ $summaryItem }}
                            </span>
                        @endforeach
                    </div>
        ...
        {{-- Expandable body --}}
        <div id="sfClientFiltersBody" class="mt-3 hidden">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var body = document.getElementById('sfClientFiltersBody');
        var toggle = document.getElementById('sfClientFiltersToggle');
