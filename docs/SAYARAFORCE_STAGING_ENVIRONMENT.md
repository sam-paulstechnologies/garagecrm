...
The pending migrations run in reviewed order after the baseline. The latest additive migration, `2026_08_13_000001_add_two_factor_security_to_users`, adds encrypted Fortify-compatible two-factor state and a sensitive-value-free security audit ledger. Two independent fresh cycles now produce 129 base tables, two valid views, 50 migration records, two explicitly subscribed synthetic tenants, zero foreign-key violations across 169 constraints, 476 routes, and identical fingerprint `05821bb5a167857fd48222d8bb16fd98ed153db4c72c0681457f5c13d6dca5fc`.
