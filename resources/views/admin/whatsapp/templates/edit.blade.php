...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    {{-- we keep an id so the preview script can read values like in edit --}}
    <form id="wa-template-form">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {{-- RIGHT: WhatsApp-like Preview (same as edit) --}}
...
(function(){
    ...
    update(); // one-time render for read-only page
})();
</script>
@endsection
