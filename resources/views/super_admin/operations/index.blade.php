...
@section('super_admin_content')
    <style>
        ...
        .ops-fullscreen { position: fixed !important; inset: 0 !important; z-index: 80; padding: 18px; background: #020617; overflow: hidden; grid-template-columns: minmax(0, 1fr) 380px; }
