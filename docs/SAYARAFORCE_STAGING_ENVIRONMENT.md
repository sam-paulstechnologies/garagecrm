...
The pending migrations run in reviewed order after the baseline. The latest additive migration, `2026_08_14_000002_create_whatsapp_history_intelligence`, adds tenant-scoped history quarantine/review, cumulative contact usage, privacy preferences, safety audits, and generic commercial usage events; it follows provider-subscription reconciliation without changing the production-derived baseline. Two independent fresh cycles now produce 135 base tables, two valid views, 52 migration records, two explicitly subscribed synthetic tenants, zero foreign-key violations across 191 constraints, 484 routes, and identical fingerprint `1edb26c7d59c3687c8e3f74f073eebb3f3a0a9496dbe016ef3a3066096178d63`.
