...
The pending migrations run in reviewed order after the baseline: `2026_08_05_000001_create_messaging_core_tables` creates seven messaging tables and `2026_08_10_000001_create_commercial_foundation` adds eight commercial-foundation tables. Two independent fresh cycles produced 118 base tables, two valid views, two explicitly subscribed synthetic tenants, zero foreign-key violations, and identical fingerprint `8a7bd0ed144ca2dc3536913d0293f66e322403eed0be4c5518c16f60a46cfd8e`.
