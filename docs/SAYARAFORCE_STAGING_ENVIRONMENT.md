...
The pending migrations run in reviewed order after the baseline. The latest additive migration, `2026_08_14_000001_harden_provider_subscription_reconciliation`, adds immutable provider invoice-line attribution and invoice-level introductory-cycle idempotency; it follows the Fortify-compatible two-factor migration without changing the baseline. Two independent fresh cycles now produce 129 base tables, two valid views, 51 migration records, two explicitly subscribed synthetic tenants, zero foreign-key violations across 169 constraints, 476 routes, and identical fingerprint `a005cb0698977f884e22babc10d481b03126183eacfe78c2846c164a7e213606`.
