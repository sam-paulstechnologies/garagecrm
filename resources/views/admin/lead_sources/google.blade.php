...
<style>
    ...
    html[data-theme="light"] .sf-growth-visual-fix .bg-slate-900\/40,
    ...
    html[data-theme="light"] .sf-growth-visual-fix input.text-slate-200 {
    ...
    html[data-theme="light"] .sf-growth-visual-fix .text-red-100 {
