...
$expectedFingerprint = 'd086c533e6898a6a8bb5ac782585aeb7e7693da2cba5ebda2587c8d791c71b30'
...
$required = @{
    ...
    PRIVATE_UPLOAD_DISK = 'staging'
    SESSION_ENCRYPT = 'true'
    SANCTUM_EXPIRATION = '60'
    SANCTUM_TOKEN_PREFIX = 'sf_'
    TRUSTED_PROXIES = '*'
    MAIL_MAILER = 'log'
    PUBLIC_REGISTRATION_ENABLED = 'true'
    TWO_FACTOR_ENFORCEMENT = 'required_admins'
    SECURITY_STEP_UP_WINDOW_MINUTES = '15'
    TWO_FACTOR_CHALLENGE_ATTEMPTS_PER_MINUTE = '5'
