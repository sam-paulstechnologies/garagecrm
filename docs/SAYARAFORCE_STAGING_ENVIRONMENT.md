...
The pending migrations run in reviewed order after the baseline: `2026_08_05_000001_create_messaging_core_tables` creates seven messaging tables, `2026_08_10_000001_create_commercial_foundation` adds eight commercial-foundation tables, `2026_08_10_000002_create_ai_monitoring_metering` adds two tenant-scoped metering/telemetry tables, `2026_08_10_000003_create_billing_engine` adds three provider-neutral billing tables plus verified-event lifecycle fields, and `2026_08_10_000004_create_mobile_notification_foundation` adds two tenant-scoped notification tables. Two independent fresh cycles produced 125 base tables, two valid views, two explicitly subscribed synthetic tenants, zero foreign-key violations, and identical fingerprint `62e255336ee6f481ed2178673defcb9d264a8199971349771dcdb380631c1e5b`.
