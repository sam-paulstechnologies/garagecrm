...
<div id="sfBookingFilters" class="sf-booking-panel rounded-2xl border p-4 shadow-sm">
    <form method="GET" action="{{ route('admin.bookings.index') }}">
        ...
        {{-- Expandable body --}}
        <div id="sfBookingFiltersBody" class="mt-5 hidden">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var body = document.getElementById('sfBookingFiltersBody');
        var toggle = document.getElementById('sfBookingFiltersToggle');
        var dateRange = document.getElementById('bookingDateRange');
        var customFields = document.getElementById('bookingCustomDateFields');
