...
<div class="max-w-3xl mx-auto p-6 space-y-4">
  <div class="flex items-center justify-between">
    ...
    <div class="space-x-2">
      <a href="{{ route('communications.edit', $communication) }}" class="px-3 py-1 bg-gray-800 text-white rounded">Edit</a>
  ...
  <div class="bg-white rounded shadow p-4 space-y-2">
    <div><span class="font-medium">Client:</span>
      @if($communication->client)
        <a class="text-blue-600 hover:underline" href="{{ route('clients.show', $communication->client) }}">
