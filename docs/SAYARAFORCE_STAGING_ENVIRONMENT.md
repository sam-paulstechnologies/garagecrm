...
The pending migrations run in reviewed order after the baseline: `2026_08_05_000001_create_messaging_core_tables` creates seven messaging tables, `2026_08_10_000001_create_commercial_foundation` adds eight commercial-foundation tables, and `2026_08_10_000002_create_ai_monitoring_metering` adds two tenant-scoped metering/telemetry tables. Two independent fresh cycles produced 120 base tables, two valid views, two explicitly subscribed synthetic tenants, zero foreign-key violations, and identical fingerprint `163f55f3252e9b6aa6b4426d1124622d34de71ae9f03636cd5fdb2b1742259fb`.
