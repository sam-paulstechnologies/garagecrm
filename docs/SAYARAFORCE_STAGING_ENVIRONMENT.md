...
The pending migrations run in reviewed order after the baseline: `2026_08_05_000001_create_messaging_core_tables` creates seven messaging tables, `2026_08_10_000001_create_commercial_foundation` adds eight commercial-foundation tables, `2026_08_10_000002_create_ai_monitoring_metering` adds two tenant-scoped metering/telemetry tables, and `2026_08_10_000003_create_billing_engine` adds three provider-neutral billing tables plus verified-event lifecycle fields. Two independent fresh cycles produced 123 base tables, two valid views, two explicitly subscribed synthetic tenants, zero foreign-key violations, and identical fingerprint `ffcb44d1847c7d9c75d710ad8a868b4ea55424a659ffbd62aef9597ecbab7697`.
