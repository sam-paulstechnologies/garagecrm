...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-6">
    ...
    <a
        href="{{ route('admin.bookings.index', array_merge($baseQuery, ['bucket' => 'today'])) }}"
    ...
    <a
        href="{{ route('admin.bookings.index', array_merge($baseQuery, ['status' => 'converted_to_job'])) }}"
    ...
    <a
        href="{{ route('admin.bookings.index', array_merge($baseQuery, ['status' => 'lost'])) }}"
