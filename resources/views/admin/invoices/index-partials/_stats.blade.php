{{-- resources/views/admin/invoices/index-partials/_stats.blade.php --}}
...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
    <a
        href="{{ route('admin.invoices.index', $baseQuery) }}"
        class="sf-stat-card {{ $currentStatus === '' ? 'ring-1 ring-orange-400/30 border-orange-400/40' : '' }}"
    >
    ...
    <a
        href="{{ route('admin.invoices.index', array_merge($baseQuery, ['status' => 'paid'])) }}"
        class="sf-stat-card {{ $currentStatus === 'paid' ? 'ring-1 ring-orange-400/30 border-orange-400/40' : '' }}"
    >
    ...
    <a
        href="{{ route('admin.invoices.index', array_merge($baseQuery, ['status' => 'pending'])) }}"
        class="sf-stat-card {{ $currentStatus === 'pending' ? 'ring-1 ring-orange-400/30 border-orange-400/40' : '' }}"
    >
    ...
    <a
        href="{{ route('admin.invoices.index', array_merge($baseQuery, ['status' => 'overdue'])) }}"
        class="sf-stat-card {{ $currentStatus === 'overdue' ? 'ring-1 ring-orange-400/30 border-orange-400/40' : '' }}"
    >
