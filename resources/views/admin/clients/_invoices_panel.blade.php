...
<div class="bg-white p-6 rounded-lg shadow">
  <div class="flex items-center justify-between mb-3">
    ...
    <div class="flex items-center gap-3">
      <a href="{{ route('admin.invoices.index') }}?client_id={{ $client->id }}" class="text-sm text-blue-600 underline">View all</a>
...
<div id="{{ $modalId }}" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-40">
  <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl mx-4">
    ...
    <form method="POST" action="{{ route('admin.clients.invoices.upload', $client) }}" enctype="multipart/form-data" class="p-5 space-y-4">
      @csrf
      <div>
