...
class InboxController extends Controller
{
    ...
    public function send(Request $request, WhatsAppService $wa): JsonResponse
    {
        ...
        try {
            ...
            Log::warning('[Inbox] Manager WhatsApp send failed', [
                'company_id' => $companyId,
    ...
    */
    ...
    public function reply(Request $request, Lead $lead, WhatsAppService $wa)
    {
        ...
        try {
            ...
            Log::warning('[Inbox] Manager lead reply WhatsApp send failed', [
                'company_id' => $companyId,
                'conversation_id' => $conversation->id,
                'lead_id' => $lead->id,
                'error' => $e->getMessage(),
            ...
            return back()->with('error', 'WhatsApp message could not be sent. Please check WhatsApp settings and try again.');
        }
    ...
    */
    ...
    {
        $companyId = (int) ($conversation->company_id ?? 0);
