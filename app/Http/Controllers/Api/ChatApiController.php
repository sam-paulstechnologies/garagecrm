...
class ChatApiController extends Controller
{
    ...
    public function thread(Request $request, int $conversationId)
    {
        ...
        $conv = Conversation::where('company_id', $companyId)
    ...
    public function suggest(Request $request, int $conversationId)
    {
        $companyId = $this->companyId($request);
        ...
        if (!$inbound) {
            return response()->json(['ok' => false, 'reason' => 'no_inbound'], 404);
        }
