{{-- resources/views/admin/clients/archive-partials/_client_card.blade.php --}}
    ...
    <div class="p-5">
        <div class="pr-28">
            ...
            <div class="mt-4 flex flex-wrap gap-1.5">
                <span class="inline-flex rounded-full bg-red-500/10 px-2 py-0.5 text-[10px] font-black uppercase tracking-wide text-red-300 ring-1 ring-red-400/20">
                    Archived
                </span>
        ...
        <div class="mt-5 flex flex-wrap gap-2">
            @if(\Illuminate\Support\Facades\Route::has('admin.clients.show'))
                <a
            ...
            @if(\Illuminate\Support\Facades\Route::has('admin.clients.restore'))
                <form
                    action="{{ route('admin.clients.restore', $client->id) }}"
                    method="POST"
                ...
                >
                    ...
                    <button
                        type="submit"
                        class="inline-flex h-8 items-center justify-center rounded-lg bg-emerald-500/10 px-3 text-xs font-bold text-emerald-300 ring-1 ring-emerald-400/20 transition hover:bg-emerald-500/15"
                    >
                        Restore
                    </button>
                </form>
