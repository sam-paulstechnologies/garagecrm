        ...
        <div class="mb-5 flex flex-col gap-3 rounded-3xl border border-orange-400/20 bg-orange-500/10 px-5 py-4 text-sm font-bold text-orange-200 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                @if(config('quick_scan.enabled'))
                    <a href="{{ route('super-admin.quick-scans.index') }}" class="rounded-2xl px-4 py-2 text-xs font-extrabold {{ request()->routeIs('super-admin.quick-scans.*') ? 'bg-orange-500 text-white' : 'bg-white/10 text-white hover:bg-white/15' }}">Quick Scans</a>
                @endif
